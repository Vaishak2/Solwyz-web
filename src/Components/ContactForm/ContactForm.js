...
function ContactForm() {
  ...
  return (
    <div className='bg-contact-formBackground sm:pt-40 pt-24 pb-48 ' id='contactUs'>
      <div className='font-urbanist'>
        <div className='sm:text-[55px] text-[25px] tracking-wider'>
      ...
      <form onSubmit={onSubmit} className='sm:px-24 px-5 py-5 border-2 border-black lg:w-[75%] w-[90%] mx-auto mt-10'>
        ...
        <button
          ...
          className="flex justify-around bg-banner-buttonBackground text-white hover:text-gray-300 font-bold py-2 px-4 rounded-full sm:w-[248px] w-[170px] sm:h-[66px] h-[50px] sm:mr-0  mb-10 mx-auto"
